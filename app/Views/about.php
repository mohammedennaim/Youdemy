...
<body>
	...
	<header class="header">
		...
		<div class="feature">
			<div class="feature_background" style="background-image:url(./etudiant/images/courses_background.jpg)">
			</div>
			<div class="container">
				<div class="row">
					<div class="col">
					...
					<div class="col-lg-6 feature_col">
						<div class="feature_video d-flex flex-column align-items-center justify-content-center">
							<div class="feature_video_background"
								style="background-image:url(./etudiant/images/video.jpg)"></div>
					...
					<div class="col">
						<div class="partners_slider_container">
							<div class="owl-carousel owl-theme partners_slider">
								...
								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_1.png" alt="">
								</div>

								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_2.png" alt="">
								</div>

								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_3.png" alt="">
								</div>

								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_4.png" alt="">
								</div>

								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_5.png" alt="">
								</div>

								<!-- Partner Item -->
								<div class="owl-item partner_item"><img src="./etudiant/images/partner_6.png" alt="">
								</div>
